...
// // // // function sub(num1,num2){ // n1 = 20 , num2 = 20
...
// // // // function a(call1,a,b,c){ // call1 = b , a = 1 , b = 2 , c = 3

// // // //     console.log(a+c); // 1 + 3 = 4
...
// // // //   alert(`now black day sales on going, ${product} offer going on maximum ${discount} % `);
// // // // })("shirts",50);
...
// // // function* gen(){
// // //     yield "50% flat offer you got"
// // //     yield "try again better luck next time"
// // //     yield "10% flat offer you got"
// // //     yield "70% flat offer you got"
// // //     yield "100% cashback"
// // // }
...
// // // // block of code 
// // // // repeatation
// // // // specific task assign
// // // // code reusable
// // // // self invoke function
// // // // easily pass value - dynamic value
// // // // generator function value
// // // // callback and higher order function
// // // // we can set default parameter
// // // // scopes
// // // // hoisting
// // // // outer object we can call in function

// // // console.clear();


// // // // Data Stracture - (ES6 Edition) - Ecma Script - 2015

// // // // Spread operator 

// // // // we can take merge value , clone
...
// // // let Total = [...arr1,...arr2,9,10,11,12]
...
// // // // we can give multiple argument in single parameter
...
// // // let re4 = nested[3][0]
// // // let re5 = nested[3][1]
// // // let re6 = nested[3][2][0]
// // // let re7 = nested[3][2][1]
// // // let re8 = nested[3][2][2][0]

// // // console.log(re1,re2,re6,re7,re8);


// // // let [c1,c2,c3,[c4,c5,[c6,c7,[c8]]]] = nested

// // // console.log(c1,c2,c3,c6,c7,c8);
...
// // // let d1 = employee.name1
// // // let d2 = employee.salary
// // // let d3 = employee.role
...
// // // let {name1,salary,role} = employee

// // // console.log(name1,salary,role);
...
// // // let array = [1,2,3,4,"hello",true,undefined,null,[1,2,3],{k:1}]
...
// // // // if your will adding concept , you can add multiple value.
// // // // if your will remove concept , you can remove only one value.
...
// // // check.push(4,5,6,7,8,9,10)

// // // console.log(check);


// // // // splice(// startingIndex , // DeleteCount , // Adding)

// // // let example = [1,2,3,40,50,6,7,8]

// // // example.splice(3,2,4,5)
...
// // // // multiple argument store in single parameter
...
// // // //     let [f1,f2,f3,f4,f5] = c
    
// // // //     console.log(a+b + f1 + f5);


// // // // }

// // // // arrow1(1,2,3,4,5,6,7)
...
// // let newArr = arr1.concat(arr2,9,10)
...
// // let arr6 = [1,2,3,4,10,30,22]

// // let includesVal = arr6.includes(5)

// // console.log(includesVal);

// // // 6. sort()

// // let arr7 = ["A",4,5,2000,9,8,1,0,6] // 2.000 < 4 = true

// // let sortVal = arr7.sort()

// // console.log(sortVal);

// // // 7. indexOf()

// // let arr8 = [1,2,3,4,3,2,1]

// // let indexVal = arr8.indexOf(2) // value, fromIndex

// // console.log(indexVal);

// // // 8. lastIndexOf()

// // let lastIndexVal = arr8.lastIndexOf(2) // value , fromIndex
...
// // let arr5 = [1,2,3,4] // 1,2,3,"four"

// // arr5.fill("four",1,3) // value,sI , eI+1
...
// // let arr3 = [1,2,3,4,50,"hello","hi",8,9,10]

// // let sliceVal = arr3.slice(5,7) // SI , EI+1
...
// let games = ["cricket","volley ball","foot ball","basket ball","hockey","tennis"]
...
// let newFilter = employeeSalary.filter((c,i,t)=>{
...
// let newFind = employeeSalary.find((c,i,t)=>{
//    return c.salary > 300000;
// })
...
// let overAllSalary = employeeSalary.reduce((acc,c,i,t)=>{
//   return acc + c.salary
...
// let everyVal = array2.every((c,i,t)=>{
//   return c % 2 == 0
// })
...
// let array3 = [1000,1,11,200,3,30005,56]

// let arrval = array3.sort()
...
// let allCount = aa.reduce((acc,c,i,t)=>{
// return acc + c
// // 0 + 1 = 1
// // 1 + 2 = 3
// // 3 + 3 = 6
...
//   indexOf(), v --> i
console.log(str.indexOf("A",3)); // value , fromIndex
...
let str1 = "python developer"

console.log(str1.replace("python","frontend")); // 
...
// we connect to backend

// we can manage API - format - link


// Resolve   - successful data - .then()
...
// Api link :- https://jsonplaceholder.typicode.com/todos/1
